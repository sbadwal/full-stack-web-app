...
// sweet dish (dessert) recipes. Run with `npm run seed`.
import bcrypt from 'bcryptjs';
import db from './index.js';

// Create (or reuse) a demo user that will "own" the seeded recipes.
const seedEmail = 'desserts@example.com';
const seedName = 'Dessert Chef';
...
// List of sweet dish recipes to insert, each with ingredients and steps.
const sweetRecipes = [
  {
...
console.log(`Seeded ${inserted} new sweet dish recipe(s).`);
